# Generated by Django 5.2.7 on 2025-10-22 01:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Cliente'), ('business', 'Comerciante'), ('admin', 'Administrador')], default='customer', max_length=10, verbose_name='Tipo de Usuario')),
                ('phone', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(message='El número de teléfono debe tener entre 9 y 15 dígitos', regex='^\\+?1?\\d{9,15}$')], verbose_name='Teléfono')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100, verbose_name='Título de la Dirección')),
                ('full_address', models.TextField(verbose_name='Dirección Completa')),
